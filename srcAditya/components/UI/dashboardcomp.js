...
const Dashboardcomp = ({imgurl,country,city,onpress=()=>{}}) => {
  ...
  return (
        ...
        <TouchableOpacity onPress={onpress} style={{overflow:'hidden',borderRadius:20,marginHorizontal:10,marginVertical:10}}>
  ...
  return(
    <View style={{flexDirection:"row"}}>
      ...
      <View style={{paddingVertical:20,marginHorizontal:10}}>
        ...
        Visit the former Tempelhof Airport, which has been transformed into a massive urban park where you can walk, cycle, skate, and even fly kites.
        </Text>
