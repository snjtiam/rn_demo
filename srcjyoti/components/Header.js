...
const Header=()=>{
  ...
  return(
    <View style={{borderWidth:1,marginHorizontal:5, borderColor:'#ffeeda' ,height:'44%',backgroundColor:'#ffeeda', borderRadius:25,}}>
    ...
    <View>
    <Text style={{fontSize:25, marginTop:20}}>Hello,<Text style={{fontWeight:"bold",}}>Jyoti</Text></Text>
