...
const FirstImgDetails = () =>{
    ...
    return(
        <View>
            ...
            <TouchableOpacity style={{ marginHorizontal:35, borderRadius:20,  marginHorizontal:35, borderRadius:20, overflow:'hidden'}}>
            <ImageBackground  style={{height:400, width:340,resizeMode:'center' }}source={require('../../assets/Ktm.jpg')}>
            </ImageBackground>
            </TouchableOpacity>
           
        <SafeAreaView style={{marginHorizontal:28,alignItems:'center', marginTop: 10, }}>
...
const SecondImgDetails = () =>{
    ...
    return(
        <View>
            ...
            <TouchableOpacity style={{ marginHorizontal:35, borderRadius:20,  marginHorizontal:35, borderRadius:20, overflow:'hidden'}}>
            <ImageBackground  style={{height:400, width:340,resizeMode:'center' }}source={require('../../assets/Mt.everest.jpg')}>
            </ImageBackground>
            </TouchableOpacity>   
            <SafeAreaView style={{marginHorizontal:28,alignItems:'center', marginTop: 10, }}>
            <ReadMore numberOfLines={4} readMoreText="See More"  >
...
const ThirdImgDetails = () =>{
    ...
    return(
        <View>
            ...
            <TouchableOpacity style={{ marginHorizontal:35, borderRadius:20,  marginHorizontal:35, borderRadius:20, overflow:'hidden'}}>
            <ImageBackground  style={{height:400, width:340,resizeMode:'center' }}source={require('../../assets/Pokhara.jpg')}>
            </ImageBackground>
            </TouchableOpacity>   
            <SafeAreaView style={{marginHorizontal:28,alignItems:'center', marginTop: 10, }}>
            <ReadMore numberOfLines={4} readMoreText="See More"  >
...
const ForthImgDetails = () =>{
    ...
    return(
        <View>
            ...
            <TouchableOpacity style={{ marginHorizontal:35, borderRadius:20,  marginHorizontal:35, borderRadius:20, overflow:'hidden'}}>
            <ImageBackground  style={{height:400, width:340,resizeMode:'center' }}source={require('../../assets/Nagarkot.jpg')}>
            </ImageBackground>
            </TouchableOpacity>   
            <SafeAreaView style={{marginHorizontal:28,alignItems:'center', marginTop: 10, }}>
            <ReadMore numberOfLines={4} readMoreText="See More"  >
...
const FifthImgDetails = () =>{
    ...
    return(
        <View>
            ...
            <TouchableOpacity style={{ marginHorizontal:35, borderRadius:20,  marginHorizontal:35, borderRadius:20, overflow:'hidden'}}>
            <ImageBackground  style={{height:400, width:340,resizeMode:'center' }}source={require('../../assets/Bhaktapur.jpg')}>
            </ImageBackground>
            </TouchableOpacity>   
            <SafeAreaView style={{marginHorizontal:28,alignItems:'center', marginTop: 10, }}>
            <ReadMore numberOfLines={4} readMoreText="See More"  >
