...
const DestinationUI = () => {
  ...
  const data = [
    {
      imgUrl: require('../../assets/images/Mt.everest.jpg'),
    ...
    {
      imgUrl: require('../../assets/images/Pokhara.jpg'),
    ...
    {
      imgUrl: require('../../assets/images/Nagarkot.jpg'),
    ...
    {
      imgUrl: require('../../assets/images/Bhaktapur.jpg'),
